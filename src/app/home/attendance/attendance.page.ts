...
//   loadAttendanceData() {
//     // This is where you'd call your service to get the data
//     // For now, we simulate the structure your HTML expects
//     this.attendance = {
...
//   // This triggers the CSS animation automatically
//   this.isSubmitting = true; 
 
//   // Optional: keep your loading controller if you want the popup as well
//   const loader = await this.loadingCtrl.create({
//     message: 'Syncing...',
//     duration: 2000 // Match this to your CSS transition time if desired
//   });
...
//     },
//     error: (err) => {
//       this.isSubmitting = false; // Resets the slide to the left on error
//       loader.dismiss();
  ...
  async submitAttendance() {
    ...
    this.http.post(this.apiUrl, payload).subscribe({
      next: (res: any) => {
        loader.dismiss();
        this.presentToast('Attendance Success!', 'success');
        this.attendance = res; // Database time now updates the UI
